...
export default () => {
   ...
   const topEdge = bottomActions?.y - height + bottomActions?.height * 1.6;
   ...
   return (
      <View>
         ...
         <Animated.ScrollView
            ...
            <View style={[styles.bottomActions]} onLayout={(event) => setBottomActions(event.nativeEvent.layout)} />
            <View>
         ...
         {bottomActions && (
            <Animated.View
               ...
               <View style={{ flexDirection: 'row' }}>
                  <Animated.View style={[styles.icon, { opacity: scrollY.interpolate({ inputRange, outputRange: [0, 0, 0, 1, 1] }) }]}>
                     <Entypo name="export" size={24} color="black" />
                  </Animated.View>
                  <Animated.View
                     style={[styles.icon, { transform: [{ translateX: scrollY.interpolate({ inputRange, outputRange: [60, 60, 60, 0, 0] }) }] }]}>
